...
folder = '/Users/pbortolo/work/3_projects/3_BAR/stability/outputs/bar_usc'
folder_of = 'stability_bar_usca_towdt_ctrl'
...
ax[0].plot(ws, freq_of[:,3], c = np.array(Hawaii_13.colors[3])/256., linestyle='-', linewidth=lw)
ax[0].plot(ws, freq_of[:,4], c = np.array(Imola_9.colors[0])/256., linestyle='-', linewidth=lw)
ax[0].plot(ws, freq_of[:,5], c = np.array(Imola_9.colors[1])/256., linestyle='-', linewidth=lw)
ax[0].plot(ws, freq_of[:,6], c = np.array(Imola_9.colors[2])/256., linestyle='-', linewidth=lw)
ax[0].plot(ws, freq_of[:,7], c = np.array(Hawaii_13.colors[4])/256., linestyle='-', linewidth=lw)
ax[0].plot(ws, freq_of[:,8], c = np.array(Hawaii_13.colors[5])/256., linestyle='-', linewidth=lw)
ax[0].plot(ws, freq_of[:,9], c = np.array(Imola_9.colors[3])/256.,  linestyle='-.', linewidth=lw)
...
ax[0].plot(ws, freq_of[:,13], c = np.array(Hawaii_13.colors[6])/256.,  linestyle='-.', linewidth=lw)
ax[0].plot(ws, freq_of[:,14], c = np.array(Hawaii_13.colors[6])/256.,  linestyle='-.', linewidth=lw)
ax[0].plot(ws, freq_of[:,15], c = np.array(Hawaii_13.colors[6])/256.,  linestyle='-.', linewidth=lw)
...
ax[1].plot(ws, damp_of[:,3]*100., c = np.array(Hawaii_13.colors[3])/256., label = '1DTFrFr', linestyle='-', linewidth=lw)
ax[1].plot(ws, damp_of[:,4]*100., c = np.array(Imola_9.colors[0])/256., label = '1BFBW', linestyle='-', linewidth=lw)
ax[1].plot(ws, damp_of[:,5]*100., c = np.array(Imola_9.colors[1])/256., label = '1BFC', linestyle='-', linewidth=lw)
ax[1].plot(ws, damp_of[:,6]*100., c = np.array(Imola_9.colors[2])/256., label = '1BFFW', linestyle='-', linewidth=lw)
ax[1].plot(ws, damp_of[:,7]*100., c = np.array(Hawaii_13.colors[4])/256., label = '1BEBW', linestyle='-', linewidth=lw)
ax[1].plot(ws, damp_of[:,8]*100., c = np.array(Hawaii_13.colors[5])/256., label = '1BEFW', linestyle='-', linewidth=lw)
ax[1].plot(ws, damp_of[:,9]*100., c = np.array(Imola_9.colors[3])/256., label = 'UHD', linestyle='-.', linewidth=lw)
ax[1].plot(ws, damp_of[:,10]*100., c = np.array(Hawaii_13.colors[6])/256., label = 'ULD', linestyle='-.', linewidth=lw)
...
ax[1].plot(ws, damp_of[:,13]*100., c = np.array(Hawaii_13.colors[6])/256., linestyle='-.', linewidth=lw)
ax[1].plot(ws, damp_of[:,14]*100., c = np.array(Hawaii_13.colors[6])/256., linestyle='-.', linewidth=lw)
ax[1].plot(ws, damp_of[:,15]*100., c = np.array(Hawaii_13.colors[6])/256., linestyle='-.', linewidth=lw)
...
fig.suptitle('BAR-USC', weight='bold')
#ax[1].legend()
ax[1].grid(color=[0.8, 0.8, 0.8], linestyle="--")
ax[1].legend(bbox_to_anchor=(0.35, 0.02,1,1))
plt.tight_layout()
fig.savefig(os.path.join(folder_plots, 'campbell_bar_usc_aero.pdf'))
fig.savefig(os.path.join(folder_plots, 'campbell_bar_usc_aero.png'))
plt.show()
