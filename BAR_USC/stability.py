...
if __name__ == '__main__':
    ...
    fastBatch.FAST_InputFile = 'BAR_USC.fst'
    fastBatch.FAST_directory = '/home/pbortolo/BAR_Designs/BAR_USC/OpenFAST'

    folder_name = 'stability_bar_usc'
    if aero_flag:
        folder_name += 'a_'
    else:
        folder_name += 's_'
